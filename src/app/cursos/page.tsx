...
// Interfaz actualizada para incluir 'order' y 'createdAt'
interface Lesson {
  id: string;
  title: string;
  videoUrl?: string;
...
// Función para detectar archivos que se pueden previsualizar (PDF, imágenes)
        ...
        <aside className="w-full lg:w-1/3 bg-surface p-4 rounded-lg shadow-lg border border-primary/20 h-fit">
          ...
          <ul>
            {lessons.map((lesson, index) => {
              ...
              // --- CAMBIO PRINCIPAL: Siempre desbloqueado para inscritos ---
              const isUnlocked = true; 

              return (
                <li key={lesson.id}
                  // Ahora el click funciona siempre si estás inscrito
                ...
                >
                  ...
                  {/* El candado solo se muestra si NO está desbloqueado, pero como isUnlocked es true, esto nunca se muestra si estás inscrito */}
